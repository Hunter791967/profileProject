                ...
                <div class="row align-items-center justify-content-center justify-content-lg-between">
                    <div class="col-lg-6 order-0 order-lg-2">
                        <div class="banner__img text-center text-xxl-end">
                            <img src="{{ asset('frontDesign/img/banner/amr01.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6">
                        <div class="banner__content">
                            ...
                            <a href="about.html" class="btn banner__btn wow btn_first">More Details</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <ul class="about__icons__wrap">
                            ...
                            <li>
                                <img class="light" src="{{ asset('frontDesign/img/icons/skeatch_light.png') }}"
                                    alt="Skeatch">
                                <img class="dark" src="{{ asset('frontDesign/img/icons/skeatch.png') }}" alt="Skeatch">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('frontDesign/img/icons/illustrator_light.png') }}"
                                    alt="Illustrator">
                                <img class="dark" src="{{ asset('frontDesign/img/icons/illustrator.png') }}"
                                    alt="Illustrator">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('frontDesign/img/icons/hotjar_light.png') }}"
                                    alt="Hotjar">
                                <img class="dark" src="{{ asset('frontDesign/img/icons/hotjar.png') }}" alt="Hotjar">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('frontDesign/img/icons/invision_light.png') }}"
                                    alt="Invision">
                                <img class="dark" src="{{ asset('frontDesign/img/icons/invision.png') }}" alt="Invision">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('frontDesign/img/icons/photoshop_light.png') }}"
                                    alt="Photoshop">
                                <img class="dark" src="{{ asset('frontDesign/img/icons/photoshop.png') }}"
                                    alt="Photoshop">
                            </li>
                            <li>
                                <img class="light" src="{{ asset('frontDesign/img/icons/figma_light.png') }}"
                                    alt="Figma">
                ...
                <div class="row gx-0 services__active">
                        ...
                        <div class="services__item">
                            <div class="services__thumb">
                                <a href="services-details.html"><img
                                        src="{{ asset('frontDesign/img/images/services_img01.jpg') }}" alt=""></a>
                            </div>
                            <div class="services__content">
                                <div class="services__icon">
                                    <img class="light"
                                        src="{{ asset('frontDesign/img/icons/services_light_icon01.png') }}"
                                        alt="">
                                    <img class="dark" src="{{ asset('frontDesign/img/icons/services_icon01.png') }}"
                                        alt="">
                                </div>
                    ...
                    <div class="col-xl-3">
                        <div class="services__item">
                            <div class="services__thumb">
                                <a href="services-details.html"><img
                                        src="{{ asset('frontDesign/img/images/services_img02.jpg') }}"
                                        alt=""></a>
                            </div>
                            <div class="services__content">
                                <div class="services__icon">
                                    <img class="light"
                                        src="{{ asset('frontDesign/img/icons/services_light_icon02.png') }}"
                                        alt="">
                                    <img class="dark" src="{{ asset('frontDesign/img/icons/services_icon02.png') }}"
                                        alt="">
                                </div>
                    ...
                    <div class="col-xl-3">
                        <div class="services__item">
                            <div class="services__thumb">
                                <a href="services-details.html"><img
                                        src="{{ asset('frontDesign/img/images/services_img03.jpg') }}"
                                        alt=""></a>
                            </div>
                            <div class="services__content">
                                <div class="services__icon">
                                    <img class="light"
                                        src="{{ asset('frontDesign/img/icons/services_light_icon03.png') }}"
                                        alt="">
                                    <img class="dark" src="{{ asset('frontDesign/img/icons/services_icon03.png') }}"
                                        alt="">
                                </div>
                    ...
                    <div class="col-xl-3">
                        <div class="services__item">
                            <div class="services__thumb">
                                <a href="services-details.html"><img
                                        src="{{ asset('frontDesign/img/images/services_img04.jpg') }}"
                                        alt=""></a>
                            </div>
                            <div class="services__content">
                                <div class="services__icon">
                                    <img class="light"
                                        src="{{ asset('frontDesign/img/icons/services_light_icon04.png') }}"
                                        alt="">
                                    <img class="dark" src="{{ asset('frontDesign/img/icons/services_icon04.png') }}"
                                        alt="">
                                </div>
...
@section('page_title', 'Front HomePage')
