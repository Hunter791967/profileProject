                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                    aria-label="Browser: activate to sort column ascending">USER_NAME
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                    aria-label="Platform(s): activate to sort column ascending">
                                    EMAIL</th>
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                    aria-label="Engine version: activate to sort column ascending">ROLES
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                    aria-label="CSS grade: activate to sort column ascending">PERMISSIONS
                                </th>
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                    aria-label="CSS grade: activate to sort column ascending">Options
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td class="option_ud col_width">
                                    ...
                                    @endif
                                    @if (Auth::user()->hasPermission('users-update'))
                                    <a href="{{ route('user.edit', ['user' => $singleData->id]) }}" type="submit" class="btn
...
>>>>>>> 5fcc1c776157f881a329d9288c0ca2f58fce2a9e
                </div>
            </div>
        </div>
    </div>
